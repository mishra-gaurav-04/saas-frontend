  ...
  const OnBoard = ({ toggle, setToggle }: any) => {
    ...
    const handleSubmit = async(e : any) => {
      ...
      try{
        ...
        const updates = await userOnboarding({userId,onBoarding:onBoardingData});
      ...
      <>
        <div className="flex flex-col h-screen w-full bg-gray-100">
          ...
          <div className="flex items-center w-full justify-center flex-grow">
            <form onSubmit={handleSubmit} className="w-[80%] bg-white p-4 rounded-xl shadow-2xl border-2">
